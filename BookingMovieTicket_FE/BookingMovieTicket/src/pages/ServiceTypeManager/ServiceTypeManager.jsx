                    ...
                    <div className="bg-white col-span-10 h-[100vh] p-[10px]">
                        ...
                        <div className="flex mt-6 w-full mb-6">
                            <div className="w-full">
                                <p className="font-bold text-[28px]">QUẢN LÝ LOẠI DỊCH VỤ</p>
                            </div>
                            <div className="flex justify-end items-end w-full gap-x-10 pr-[100px]">
                                <Link to={"/serviceTypeManager/addServiceType"}>
                                    ...
                                    <tbody>
                                        {serviceTypes.length > 0 ? (
                                            serviceTypes.map((serviceType) => (
                                                ...
                                                >
                                                    <td className="px-4 py-2">{serviceType.name}</td>
                                                    <td className="px-4 py-2 flex space-x-4">
                                                        <Link to={`/serviceTypeManager/editServiceType/${serviceType.id}`}>
                                                            <button className="text-blue-600 hover:text-blue-800 text-[20px] cursor-pointer mt-1.5">
                                                                <MdEdit />
                                                            </button>
                                                        </Link>
                                                        <Link to={`/serviceTypeManager/deleteServiceType/${serviceType.id}`}>
