...
function BookTicket(props) {
  ...
  const toggleSeat = (seat) => {
    ...
    const price =
      seatType.find((type) => type.seatTypeName === seat.seatTypeName)?.price ||
      0;
          ...
          {Array.from({ length: maxColumn }).map((_, colIndex) => {
            ...
            return seat ? (
              <div
                ...
                onClick={() => {
                  if (!props.occupiedSeats.includes(seat.seatId))
                    toggleSeat(seat);
                }}
              >
                {seat.seatNumber}
        ...
        <div className="flex items-center justify-center flex-col">
          ...
          <div className="flex mt-5 gap-[80px] mb-8">
            ...
            <div className="flex">
              ...
              <p className="flex justify-center items-center">Ghế VIP</p>
            </div>
            <div className="flex">
        ...
        <div className="container mx-auto mb-8">
          ...
          {serviceTypes.map((type) => (
            <div key={type.id} className="mb-6">
              <p className="text-center font-bold text-[20px] text-fuchsia-700 mt-4">
                {type.name}
              </p>
